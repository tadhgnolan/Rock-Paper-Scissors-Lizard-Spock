...
![Responsive Mockup](https://github.com/tadhgnolan/Rock-Paper-Scissors-Lizard-Spock/blob/main/documentation/images/mockup.png)

## UX

### Colour Scheme

![screenshot](https://github.com/tadhgnolan/Rock-Paper-Scissors-Lizard-Spock/blob/main/documentation/images/color-blind-check-2.png)

The color shceme references Twitch.tv, one of the most popular streaming websites in the world. I chose this, as it would be a vibrant, but familiar color scheme.

I used Adobe Color Wheel to check for color blind conflicts and c correct use of contrast.

![screenshot](https://github.com/tadhgnolan/Rock-Paper-Scissors-Lizard-Spock/blob/main/documentation/images/color-scheme.png)

![screenshot](https://github.com/tadhgnolan/Rock-Paper-Scissors-Lizard-Spock/blob/main/documentation/images/contrast-check.png)

-  Grey used for primary text.
...
![screenshot](https://github.com/tadhgnolan/Rock-Paper-Scissors-Lizard-Spock/blob/main/documentation/images/coolors.png)
...
### Player of the Game
- As a new player, I would like to learn the rules of the game so I understand how to play.
- As a new player, I would like to be able to access the game quickly .
...
- **Welcome Page**
    ...
    - A welcome/home page that presents the user with a simple, but clear explanation of the rules of the game & a link/button to begin playing.

![screenshot](https://github.com/tadhgnolan/Rock-Paper-Scissors-Lizard-Spock/blob/main/documentation/images/home_page.png)

- **Hover Animation**

    - An animation made using JavaScript which draws the users attention to the rules of the game.
...
The live link can be found [here](https://tadhgnolan.github.io/Rock-Paper-Scissors-Lizard-Spock)
...
| Source | Location | Notes |
| --- | --- | --- |
| [User Centric Resource Pack by Anthony O'Brien](https://auxfuse.github.io/userCentricResourcePack/) | entire site | used for reference throughout entire project |
| [Stack Overflow](https://stackoverflow.com/questions/710089/how-do-i-make-an-html-link-look-like-a-button) | choice buttons | solution for changing html links into buttons |
